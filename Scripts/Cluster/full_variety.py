...
# parser.add_argument("clstr", help="file clstr, output from cd-hit")
# parser.add_argument("variety_gene", help="genes corresponding to proteins that represent cluster")
# parser.add_argument("protein_reformated", help="file with cluster proteins, but using duplication when necessary")
# alinhamento é o arquivo de saída
